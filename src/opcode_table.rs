    ...
    pub fn init_prefix_instruction_table() -> Self {
        Self {
            table: [
                ...
                Opcode::new(0x38, "SRA B".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x39, "SRA C".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x3A, "SRA D".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x3B, "SRA E".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x3C, "SRA H".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x3D, "SRA L".to_string(), 2, 2, Opcode::sra_r),
                Opcode::new(0x3E, "SRA (HL))".to_string(), 4, 2, Opcode::sra_hl),
                Opcode::new(0x3F, "SRA A".to_string(), 2, 2, Opcode::sra_r),
